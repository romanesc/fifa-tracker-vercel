        ...
        <table className="w-full">
          <thead>
            <tr className="border-b dark:border-gray-700">
              <th className="py-2 text-left dark:text-gray-300">Rank</th>
          ...
          <tbody>
            {players.map((player, index) => (
              <tr key={player.id} className="border-b dark:border-gray-700">
                <td className="py-2 dark:text-gray-300">{index + 1}</td>
                <td className="py-2 dark:text-gray-300">{player.username}</td>
                <td className="py-2 dark:text-gray-300">{player.points.toFixed(2)}</td>
              </tr>
            ))}
          </tbody>
        </table>
